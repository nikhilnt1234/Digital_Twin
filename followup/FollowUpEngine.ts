 ...
 * Rules for agentic follow-up based on check-in payload.
 */
...
/** Get next follow-up questions. Logic mirrored in server/followup/engine.js. */
export function getNextFollowUps(
  checkInPayload: { transcript?: string; patient_profile?: { conditions?: string[] } | null } & Record<string, unknown>,
  followUpAnswers?: Array<{ id: string; answer: unknown }>
): FollowUpResult {
  ...
  function add(q: FollowUpQuestion) {
